...
def register_pipelines() -> dict[str, Pipeline]:
    ...
    return {
        "__default__": clean_pipe + enrich_pipe + reporting_pipe + forecasting_pipe + forecast_tune_pipe,
        "no-sample": enrich_pipe + reporting_pipe + forecasting_pipe + forecast_tune_pipe,
