...
\endhead
\endfoot
AIPE & \textit{Adaptive Inventory Policy Engine} & Framework metodológico que recomenda políticas de reposição por série loja-produto. \\
...
CV\textsuperscript{2} & Quadrado do coeficiente de variação & Medida de variabilidade relativa da demanda. \\
...
RL & \textit{Reinforcement Learning} & Família de métodos de aprendizado por reforço incluída como política candidata. \\
GA & \textit{Genetic Algorithm} & Meta-heurística usada como política candidata e como componente de políticas híbridas. \\
SA & \textit{Simulated Annealing} & Meta-heurística usada para otimização de parâmetros de políticas de reposição. \\
PSO & \textit{Particle Swarm Optimization} & Meta-heurística baseada em enxame usada como política candidata. \\
DE & \textit{Differential Evolution} & Meta-heurística evolutiva usada para otimização de parâmetros. \\
DQN & \textit{Deep Q-Network} & Agente de aprendizado por reforço avaliado como política candidata. \\
PPO & \textit{Proximal Policy Optimization} & Agente de aprendizado por reforço avaliado como política candidata. \\
SARSA & \textit{State-Action-Reward-State-Action} & Agente de aprendizado por reforço tabular avaliado como política candidata. \\
...
Jornaleiro / \textit{Newsvendor} & Política de período único baseada em quantil da demanda & Política clássica usada como baseline de reposição. \\
...
NFL & \textit{No Free Lunch} & Teorema que justifica a inexistência de uma política universalmente superior para todos os perfis de demanda. \\
...
XGBoost & \textit{Extreme Gradient Boosting} & Modelo baseado em árvores e gradiente boosting usado para previsão e classificação. \\
LightGBM & \textit{Light Gradient Boosting Machine} & Modelo alternativo de boosting considerado para classificação supervisionada. \\
...
Kedro & Framework de engenharia de dados & Ferramenta usada para organizar pipelines reprodutíveis de processamento e simulação. \\
