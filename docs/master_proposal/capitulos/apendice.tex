...
\chapter*{\centering Apêndice~A --- Matriz Completa de Parâmetros Experimentais}
\addcontentsline{toc}{chapter}{Apêndice~A --- Matriz Completa de Parâmetros Experimentais}
...
Avaliação & modo de avaliação & walk-forward & janela deslizante; 17 ciclos de treino \\
...
DQN & tamanho do replay buffer & 10\,000 & \\
...
GA-DQN & tamanho do replay buffer pré-populado & 1\,000 & trajetórias geradas pelo GA \\
...
Previsão & modo walk-forward & desativado & previsão em janela fixa \\
...
XGBoost (previsão) & subsample & 0,8 & \\[3pt]
...
POD / ADI-CV\textsuperscript{2} & limiar ADI & 1,32 & classif.\ Syntetos-Boylan \\
POD / ADI-CV\textsuperscript{2} & limiar CV\textsuperscript{2} & 0,49 & classif.\ Syntetos-Boylan \\
POD / ADI-CV\textsuperscript{2} & limiar de zeros consecutivos & 5 & \\
POD / ADI-CV\textsuperscript{2} & limiar de burstiness & 0,30 & \\
POD / ADI-CV\textsuperscript{2} & limiar ACF (sazonalidade) & 0,25 & \\
POD / ADI-CV\textsuperscript{2} & coeficiente mínimo de tendência & 0,05 & \\
POD / ADI-CV\textsuperscript{2} & limiar de entropia & 2,0 & \\
POD / ADI-CV\textsuperscript{2} & média mínima de demanda & 2,0 & séries abaixo são excluídas \\
POD / ADI-CV\textsuperscript{2} & limiar CV para segmentação & 1,5 & segmentação adicional por variabilidade \\[4pt]

\multicolumn{4}{@{}l}{\textit{Geração de rótulos e PSE}} \\[2pt]
Rótulos & limiar mínimo de NS para rótulo & 0,70 & política abaixo é excluída do ranking \\
...
Estatística & post-hoc & Nemenyi & comparações múltiplas após rejeição de Friedman \\[4pt]

\multicolumn{4}{@{}l}{\textit{Ambiente computacional}} \\[2pt]
Python & versão mínima & 3.9 & \\
Kedro & versão mínima & 0.19.0 & orquestração do pipeline \\
