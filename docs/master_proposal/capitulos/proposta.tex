...
Esta seção formaliza o espaço de decisão, as métricas de avaliação, a estrutura de rede e os parâmetros operacionais locais que constituem a base do \textit{benchmark} empírico. A definição desses elementos é necessária para garantir que todas as políticas sejam avaliadas sob condições comparáveis.
