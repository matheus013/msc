...
Diferentemente da taxonomia ADI-CV$^2$, que classifica regimes gerais de demanda, os PODs foram definidos para apoiar a decisão de reposição. Eles agrupam séries que podem exigir políticas semelhantes, mesmo quando pertencem ao mesmo quadrante Syntetos-Boylan. Assim, o POD não substitui a taxonomia Syntetos-Boylan; ele acrescenta uma camada operacional de estratificação usada nesta proposta.
