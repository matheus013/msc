...
Os critérios da Tabela~\ref{tab:pod} foram definidos a partir das características calculadas na seção anterior e parametrizados em arquivo de configuração do experimento. Essa escolha preserva rastreabilidade e permite recalibrar os limiares em recortes futuros, especialmente na expansão nacional. Na tabela, a coluna ``POD'' nomeia o perfil operacional; ``Característica principal'' resume o comportamento dominante da série; ``Critério'' apresenta a regra usada para atribuir a série ao perfil; e ``Política de referência inicial'' indica uma associação preliminar usada na etapa metodológica. Essa última coluna não antecipa dominância definitiva: a dominância empírica é avaliada nos resultados, a partir do CTI e do NS observados em simulação.
