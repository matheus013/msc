...
Com base nas características acima, cada série é classificada em um dos cinco \textit{Perfis Operacionais de Demanda} (POD) por regras hierárquicas (Tabela~\ref{tab:pod}). Ao contrário da classificação Syntetos-Boylan, o POD é orientado à decisão: seu objetivo é predizer qual família de política é mais adequada, não apenas descrever o padrão de demanda. Na tabela, a coluna ``POD'' nomeia o perfil; ``Característica principal'' resume o comportamento dominante da demanda naquele perfil; ``Critério'' apresenta a regra hierárquica utilizada para classificar a série; e ``Política dominante'' indica, com base nos experimentos das Fases~1 e~2, a política de menor CTI entre as que atingem NS mínimo viável.
