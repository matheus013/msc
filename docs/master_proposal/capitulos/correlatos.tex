...
Esta seção compara como trabalhos anteriores tratam problemas próximos ao AIPE, nas mesmas cinco frentes mapeadas na introdução deste capítulo. O objetivo é explicitar o posicionamento da dissertação, não repetir fundamentos já apresentados no Capítulo~\ref{cap:tec}.
