...
\midrule
Esta dissertação (Experimento 1) & Sim & $\mathbf{2.5{-}5.4}$ & 12 & Sim & 5 \\
Esta dissertação (Experimento 2) & Sim & Lumpy; etapa nacional futura & 12 & Sim & 5 + testes \\
\bottomrule
\end{tabular}
\end{table}
