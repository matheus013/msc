...
\begin{frame}{Módulo 4 -- Regimes de demanda}
  \centering
  ...
  \small\keymessage{Syntetos-Boylan define o regime macro da demanda; no recorte BA, todas as séries avaliadas são Lumpy.}
  \note{
    Depois de definir o ambiente de simulação, vale fixar a
    ...
    regime mais desafiador para previsão e reposição. Este é o regime macro.
    No Experimento 2, todas as séries são Lumpy, mas os PODs separam
    subperfis operacionais dentro desse regime.
  }
\end{frame}
