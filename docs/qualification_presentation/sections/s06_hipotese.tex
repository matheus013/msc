...
\begin{frame}{Hipótese central}
  ...
  \note{
    ...
    políticas diferentes. A segunda é que essa relação entre características
    da série e desempenho relativo das políticas pode ser aprendida por um
    modelo supervisionado. A terceira, consequência das duas anteriores, é
    que esse modelo treinado pode generalizar para séries novas, reduzindo
    a necessidade de testar manualmente cada produto. Os resultados que vou
    apresentar sustentam parcialmente essas três premissas -- a validação
    completa da generalização ainda é trabalho futuro.
  }
\end{frame}
