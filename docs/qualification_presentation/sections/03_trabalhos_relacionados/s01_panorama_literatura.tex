...
\begin{frame}{Panorama da literatura}
  ...
  \begin{tabular}{@{}p{3.0cm}p{3.6cm}p{4.6cm}@{}}
    ...
    Meta-heurísticas & GA, SA, PSO, DE, MILP & Calibra política já escolhida, não seleciona entre famílias \\
  ...
  \note{
    ...
    melhora estimativas, mas não decide qual política usar. Meta-heurísticas
    calibram bem uma política já escolhida, mas não respondem qual família
    adotar. Agentes de aprendizado por reforço aprendem decisões sequenciais,
