% Capítulo 6 (Resultados) — Slide 2b — Regimes de demanda na taxonomia de Syntetos-Boylan
\begin{frame}{Regimes de demanda na taxonomia de Syntetos-Boylan}
  ...
  \note{
    Antes de ver a distribuição real das séries, vale fixar a leitura do
    plano ADI por CV$^2$. O eixo horizontal mede intermitência pelo ADI --
    intervalo médio entre demandas positivas; o eixo vertical mede
    variabilidade pelo CV$^2$ -- a variância normalizada do tamanho da
    demanda. Combinando os dois, a taxonomia de Syntetos-Boylan define
    quatro regimes. Smooth é demanda frequente e estável, mais fácil de
    prever e repor. Erratic é frequente, mas com tamanhos irregulares --
    aqui o desafio é a variabilidade, não a ocorrência. Intermittent tem
    muitos ciclos sem venda, mas quando a demanda ocorre o tamanho é
    relativamente estável -- o desafio é a ocorrência esporádica. Lumpy
    combina os dois problemas: muitos ciclos sem demanda e, quando ocorre,
    picos irregulares de magnitude -- é o regime mais desafiador para
    previsão e reposição. Esse enquadramento é o que usamos no próximo
    slide para ler a posição real das 145 séries do Experimento 2.
  }
\end{frame}
