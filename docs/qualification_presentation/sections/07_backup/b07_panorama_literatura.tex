% Backup — Panorama da literatura (slide original do Capítulo 3, movido do corpo
% principal; mantido para eventual pergunta da banca sobre famílias específicas)
\begin{frame}[noframenumbering]{[Backup] Panorama da literatura}
  \centering
  {\footnotesize
