...
\begin{frame}{Heterogeneidade da demanda}
  \centering
  \includegraphics[width=0.92\linewidth,height=6.0cm,keepaspectratio]{figures/figura_1_1_motivacao_aipe.pdf}\\[0.4em]
  {\small Motivação conceitual: redes varejistas apresentam séries heterogêneas;
  uma política única produz desempenho irregular.}
  \note{
